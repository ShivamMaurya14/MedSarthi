    ...
    try {
        ...
        btn.addEventListener("click", () => {
            if (isCallActive) {
                ...
                if (PUBLIC_KEY.includes("YOUR") || ASSISTANT_ID.includes("your") || ASSISTANT_ID.includes("YOUR")) {
                    alert("Error: Missing Vapi Keys! Please create a .env file, add your VAPI_PUBLIC_KEY and VAPI_ASSISTANT_ID, and restart the server.");
                    return;
                }
